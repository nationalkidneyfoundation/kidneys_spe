<div class="">
  <section class="padding-top--xxxl hero--waves-orange-tn">
    <div class="center prose padding-x--md padding-top--xxxl linkHighlight">
      <div class="font-size--md caps padding-top--lg  padding-bottom--xs">
        Your results
      </div>
      <p class="text-align--left font-size--xxxl">
        Something something something high potassium.
      </p>
     </div>
  </section>
  <section class="padding-y--xl bg--white">
    <div class="prose center padding-x--md">
      ...
      <div class="prose center font-size--lg">
        <p class="linkHighlight padding--none">
          The information you provided in the assessment suggests that...
        </p>

      </div>

      <div class="padding-y--xxxl">
