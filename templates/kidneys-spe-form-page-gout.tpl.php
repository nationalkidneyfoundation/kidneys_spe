...
<section>
  <div id="spe-return-gout" class="hide text-align--center  padding-x--md padding-y--md bg--gray-1"><?php print t('Looks like you have already answered these questions. <a class="bold" href="#" data-track="event" data-category="spe" data-action="return-to-previous">View your previous results</a>, or start over below.'); ?></div>
</section>
<section class="hero--gout margin-bottom--xxl">
  <div class="container display--flex flex-wrap--wrap align-items--center padding-y--xl padding-x--md">
    <div class="display--flex width--100 print--width--100 md--width--50 padding-top--none padding-bottom--xl md--padding-right--lg">
      <h1 class="display--inline-block  order--1 caps color--white">
